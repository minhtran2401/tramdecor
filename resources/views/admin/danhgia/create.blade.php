    ...
    <section class="section">
      <div class="section-body">
            ...
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    ...
                    <li class="breadcrumb-item"><a href="{{asset('dashboard')}}"><i class="zmdi zmdi-home"></i> Trang Chủ</a></li>
                        <li class="breadcrumb-item active">THÊM ĐÁNH GIÁ MỚI</li>
                    </ul>
                </div>
        ...
        <div class="container">
            ...
            <div class="cart">
                <form id="form_validation" method="post" action="{{route('danhgia.store')}}"   >
                    {{csrf_field()}}
                    <div class="form-group form-float">
                        <input type="text" class="form-control" placeholder="Tên Khách Hàng" name="nguoi_danhgia" required>
                    </div>
                    <div class="form-group form-float">
                        <input type="text" class="form-control" placeholder="Tên Dự Án" name="duan_danhgia" required>
                    </div>
                    <div class="form-group form-float">
                        <input type="text" class="form-control" placeholder="Nội Dung Đánh Giá" name="noidung_danhgia" required>
                    </div>
