    ...
    <section class="section">
      <div class="section-body">
            ...
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    ...
                    <li class="breadcrumb-item"><a href="{{asset('dashboard')}}"><i class="zmdi zmdi-home"></i>Trang Chủ</a></li>
                        <li class="breadcrumb-item active">THÊM LOẠI BLOG MỚI</li>
                    </ul>
                </div>
        ...
        <div class="container>
            ...
            <div class="cart">
                <form id="form_validation" method="post" action="{{route('loaiblog.store')}}" enctype="multipart/form-data"  >
                    {{csrf_field()}}
                    <div class="form-group form-float">
                        <input type="text" class="form-control" placeholder="Tên Loại" name="name_loaiblog" required>
                    </div>
